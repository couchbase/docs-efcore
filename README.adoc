...
This repository hosts the documentation source for the https://docs.couchbase.com/efcore/2.0/ROOT/overview.html[Couchbase EFCore Provider].

This branch documents the 2.0 release of the Provider, which follows the 3.9 release of the .NET SDK,
which in turn follows the https://docs.couchbase.com/dotnet-sdk/3.7/project-docs/compatibility.html#api-version[SDK 3.9 API].
