...
== Querying basics
https://learn.microsoft.com/en-us/ef/core/querying/[EF Core LINQ queries] can be executed against EF Core Couchbase DB in the same way as for other database providers. For example:
